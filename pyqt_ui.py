...
class Ui_main_layout(object):
  def setupUi(self, main_layout):
    ...
    self.frame_2.setStyleSheet("background: #fff;border: 1px solid #aaa; border-radius: 10px;max-width: 240;")
    ...
    self.pushButton.setStyleSheet(" font-size: 21px;border: none")
    ...
    self.pushButton_1.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_2.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_3.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_4.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_5.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_6.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.pushButton_7.setStyleSheet("background: #4611b1; font-size: 21px; color: #fff;")
    ...
    self.frame_3.setStyleSheet("background: #fff;border: 1px solid #aaa; border-radius: 10px; over-flow: hidden")
    ...
    self.img_label.setStyleSheet("background: #aaa; border-radius: 10px; border: 1px solid #aaa;padding: 7px")
    ...
    self.pushButton_8.setStyleSheet("font-size: 80px; color: #4611b1; border: none")
  ...
  def upload_image(self):
    ...
    if fname:
        ...
        self.two_state.setStyleSheet("background: #f1f5f9;")
  ...
  def retranslateUi(self, main_layout):
        ...
        self.pushButton_8.setText(_translate("main_layout", "Image Processing"))
